export interface AssessmentOptionCreate {
  option_text: string
  is_correct?: boolean
}
...
export interface AssessmentQuestionCreate {
  ...
  points?: number
  order_index?: number
  options: AssessmentOptionCreate[]
}
...
export interface ModuleAssessmentTeacher extends ModuleAssessment {
  questions: AssessmentQuestionWithCorrect[]
}
